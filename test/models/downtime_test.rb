...
class DowntimeTest < ActiveSupport::TestCase
  ...
  test 'overlapping event is added' do
    overlapping_event = DowntimeEvent.new(OpenStruct.new(alerted_at: DateTime.new(2019,1,1,8,00)), OpenStruct.new(alerted_at: DateTime.new(2019,1,1,8,10)))
  ...
  test 'both overlapping event are added' do
    overlapping_event1 = DowntimeEvent.new(OpenStruct.new(alerted_at: DateTime.new(2019,1,1,8,00)), OpenStruct.new(alerted_at: DateTime.new(2019,1,1,8,10)))
    overlapping_event2 = DowntimeEvent.new(OpenStruct.new(alerted_at: DateTime.new(2019,1,1,8,03)), OpenStruct.new(alerted_at: DateTime.new(2019,1,1,8,10)))
  ...
  test 'event overlapping other event is added' do
    overlapping_event1 = DowntimeEvent.new(OpenStruct.new(alerted_at: DateTime.new(2019,1,1,8,00)), OpenStruct.new(alerted_at: DateTime.new(2019,1,1,8,15)))
  ...
  test 'creates 1 downtime object from 9 overlapping events' do
    overlapping_events = [DowntimeEvent.new(OpenStruct.new(alerted_at: DateTime.new(2020,5,13,17,55)), OpenStruct.new(alerted_at: DateTime.new(2020,5,13,18,00)))]
    overlapping_events << DowntimeEvent.new(OpenStruct.new(alerted_at: DateTime.new(2020,5,13,17,55)), OpenStruct.new(alerted_at: DateTime.new(2020,5,13,18,05)))
    overlapping_events << DowntimeEvent.new(OpenStruct.new(alerted_at: DateTime.new(2020,5,13,18,00)), OpenStruct.new(alerted_at: DateTime.new(2020,5,13,18,05)))
    overlapping_events << DowntimeEvent.new(OpenStruct.new(alerted_at: DateTime.new(2020,5,13,18,07)), OpenStruct.new(alerted_at: DateTime.new(2020,5,13,18,25)))
    ...
    overlapping_events << DowntimeEvent.new(OpenStruct.new(alerted_at: DateTime.new(2020,5,13,18,00)), OpenStruct.new(alerted_at: DateTime.new(2020,5,13,18,30)))
  ...
  test 'calculate duration completely inside maintenance window on one day' do
    events = [DowntimeEvent.new(OpenStruct.new(alerted_at: Time.zone.local(2020,5,13,00,00).to_datetime), OpenStruct.new(alerted_at: Time.zone.local(2020,5,13,7,10).to_datetime))]
  ...
  test 'calculate full day outage' do
    events = [DowntimeEvent.new(OpenStruct.new(alerted_at: Time.zone.local(2020,5,13,00,00).to_datetime), OpenStruct.new(alerted_at: Time.zone.local(2020,5,14,00,00).to_datetime))]
  ...
  test 'calculate outage across 2 maintenance windows' do
    events = [DowntimeEvent.new(OpenStruct.new(alerted_at: Time.zone.local(2020,5,13,00,00).to_datetime), OpenStruct.new(alerted_at: Time.zone.local(2020,5,14,6,00).to_datetime))]
  ...
  test 'calculate outage across multiple maintenance windows' do
    events = [DowntimeEvent.new(OpenStruct.new(alerted_at: Time.zone.local(2020,5,13,00,00).to_datetime), OpenStruct.new(alerted_at: Time.zone.local(2020,5,16,16,00).to_datetime))]
