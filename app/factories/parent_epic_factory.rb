class ParentEpicFactory
  def create_from_jira(json)
    ...
    ParentEpic.new(json['id'].to_i, json['key'], json['fields']['summary'], wbso_project, fix_version, assignee)
  end

  def create_from_json(json)
    return nil if json.nil?

    parent_epic = ParentEpic.new(json['id'], json['key'], json['summary'], json['wbso_project'], json['fix_version'], json['assignee'])
